...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__20", "$compid__21", "$compid__22", "$compid__23", "$compid__24", "$compid__25", "$compid__26", "$compid__27", "shouquanBox", "infoShow"], _this.config = {
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      var _genCompid13 = (0, _taroWeapp.genCompid)(__prefix + "$compid__26"),
          _genCompid14 = _slicedToArray(_genCompid13, 2),
          $prevCompid__26 = _genCompid14[0],
          $compid__26 = _genCompid14[1];

      var _genCompid15 = (0, _taroWeapp.genCompid)(__prefix + "$compid__27"),
